...
print(f"Отпускные: {full_time_employee.get_vacation_payment()}")
...
# Проверка доступа к приватным атрибутам (должно вызывать ошибку)
# print(full_time_employee.__salary)  # Ошибка!
# print(full_time_employee.__get_vacation_salary())  # Ошибка!